...
def round_robin_alg(runs, qrels, pool_size, paths):
	...
	convert_data.write_dict_into_json(runs_status, paths['output'], "runs_status.json")
	convert_data.write_dict_into_json(retrieved_docs, paths['output'], "retrieved_docs.json")
	convert_data.write_dict_into_json(retrieved_docs_order, paths['output'], "retrieved_docs_order.json")
	convert_data.write_dict_into_json(convert_data.get_dict_from_df(run_relevancies), paths['output'], "run_relevancies.json")
	convert_data.write_dict_into_json(run_relevancies_order, paths['output'], "run_relevancies_order.json")
